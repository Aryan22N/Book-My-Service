                ...
                <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 overflow-y-auto bg-white relative z-10">
                    <div className="w-full max-w-[440px] flex flex-col gap-8">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-3xl font-bold text-[#111318] tracking-tight">Create an account</h3>
                            <p className="text-[#616f89]">Join ServiceLink to grow your business.</p>
                        </div>

                        {/* Toggle Role */}
                        <div className="flex p-1 bg-[#f6f6f8] rounded-xl">
                            <label className="flex-1 relative cursor-pointer group">
                                <input defaultChecked className="peer sr-only" name="role" type="radio" value="provider" />
                            ...
                            <label className="flex-1 relative cursor-pointer group">
                                <input className="peer sr-only" name="role" type="radio" value="customer" />
                                <div className="py-2.5 px-4 text-center text-sm font-semibold rounded-[10px] text-[#616f89] transition-all duration-200 peer-checked:bg-white peer-checked:text-[#111318] peer-checked:shadow-sm">
                                    User
                                </div>
                            </label>
                        ...
                        <form action={formAction} className="flex flex-col gap-5">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-semibold text-[#111318]" htmlFor="name">Full Name</label>
                                <div className="relative">
                                    <input required className="w-full h-12 px-4 bg-[#f6f6f8] border border-transparent rounded-xl focus:bg-white focus:border-[#135bec] focus:ring-4 focus:ring-[#135bec]/10 transition-all outline-none placeholder:text-[#616f89]/50 text-[#111318]" id="name" name="name" placeholder="John Doe / Business Name" type="text" />
                            ...
                            {/* Sign Up Button */}
                            <button disabled={isPending} className="w-full h-12 mt-2 bg-[#135bec] hover:bg-[#0f4bc4] disabled:bg-[#135bec]/50 disabled:cursor-not-allowed text-white font-bold rounded-xl shadow-lg shadow-[#135bec]/30 active:scale-[0.98] transition-all hover:cursor-pointer" type="submit">
                        ...
                        <div className="text-center pt-2">
                            <p className="text-sm text-[#616f89]">
                                ...
                                <Link className="font-semibold text-[#135bec] hover:text-[#0f4bc4] transition-colors" href="/login">
                                    Sign In
                                </Link>
                            </p>
                        </div>
